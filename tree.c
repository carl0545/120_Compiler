...
struct tree *createTreeNode(int prodr, int nkids, ...)
{
  int i;
  va_list ap;
  ...
  if (ptr == NULL) {fprintf(stderr, "tree out of memory\n"); exit(1); }
  ptr->prodrule = prodr;
  ptr->nkids = nkids;
  ptr->leafCheck = 0;
...
char *humanreadable(int prod){
   ...
   case -3000 :
   return "original_namespace_name";
   case -4000 :
   return "class_name";
   case -5000 :
   return "enum_name";
 ...
 case -79000 :
 return "named_namespace_definition";
 case -80000 :
 return "original_namespace_definition";
 case -81000 :
 return "extension_namespace_definition";
 case -82000 :
 return "unnamed_namespace_definition";
 case -83000 :
 ...
 return "type_specifier_seq";
         ...
         return "type_id_list";
         case -150000 :
         return "declaration_seq_opt";
         case -151000 :
         return "nested_name_specifier_opt";
         case -152000 :
         return "expression_list_opt";
         case -153000 :
         return "COLONCOLON_opt";
         case -154000 :
         return "new_placement_opt";
         case -155000 :
         return "new_initializer_opt";
         case -156000 :
         return "new_declarator_opt";
         case -157000 :
         return "expression_opt";
         case -158000 :
         return "statement_seq_opt";
         case -159000 :
         return "condition_opt";
         case -160000 :
         return "enumerator_list_opt";
         case -161000 :
         return "initializer_opt";
         case -162000 :
         return "constant_expression_opt";
         case -163000 :
         return "abstract_declarator_opt";
         case -164000 :
         return "type_specifier_seq_opt";
         case -165000 :
         return "direct_abstract_declarator_opt";
         case -166000 :
         return "ctor_initializer_opt";
         case -167000 :
         return "COMMA_opt";
         case -168000 :
         return "member_specification_opt";
         case -169000 :
         return "SEMICOLON_opt";
         case -170000 :
         return "conversion_declarator_opt";
         case -171000 :
         return "EXPORT_opt";
         case -172000 :
         return "handler_seq_opt";
         case -173000 :
         return "assignment_expression_opt";
         case -174000 :
         return "type_id_list_opt";
}
return "ERROR READING NON TERM NAME: humanreadable";
}
